...
`,
    ...
    },
    {
      ...
      title: "Move to the other tab group and focus its editor. SAS Studio has at most two - drag a tab to the right or bottom edge to split.",
      hotkey: { key: ",", altKey: true },
    },
    {
      name: "moveTabToOtherGroup",
      kind: "action",
      label: "Move tab to other group",
      title: "Move the current tab into the other tab group, splitting the tab area if it isn't split yet. Moving the last tab back out un-splits again; the main group can't be emptied.",
      hotkey: { key: ",", altKey: true, shiftKey: true },
    },
    {
      name: "unsplitTabGroups",
      kind: "action",
      label: "Unsplit tab groups",
      title: "Move every tab back into the main group, collapsing the split",
      hotkey: null,
    },
    {
      name: "focusTabBar",
      kind: "action",
      label: "Focus tab bar",
      title: "Move focus to the open-file tab bar - the arrow keys then move between tabs, Enter/Space selects",
      hotkey: { key: "1", altKey: true, shiftKey: true },
    },
    {
      name: "focusPaneBar",
      kind: "action",
      label: "Focus pane bar",
      title: "Move focus to the current tab's pane bar (Code / Log / Results) - the arrow keys then move between panes",
      hotkey: { key: "2", altKey: true, shiftKey: true },
    },
    {
      name: "focusSideBarTree",
      kind: "action",
      label: "Focus side bar tree",
      title: "Move focus to the left side bar's tree - the arrow keys then navigate and expand it",
      hotkey: { key: "3", altKey: true, shiftKey: true },
    },
    {
      name: "commandPalette",
      kind: "action",
